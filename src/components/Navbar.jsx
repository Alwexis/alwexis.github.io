...
export default function Navbar() {
    ...
    return (
        <section className="md:h-full w-full md:w-fit z-10 flex flex-col justify-between text-neutral-100 md:absolute md:top-0 md:left-0 animate-fade-right py-6 px-8">
            <div className="hidden md:block md:h-2/5">
                <div className="flex items-center cursor-pointer font-space-grotesk text-2xl">
                    <span>{`<`}</span>
                    <h2 className="mx-1 font-semibold">AS</h2>
                    <span>{`/>`}</span>
                </div>
            </div>
            <div className="h-fit flex justify-between md:flex-col md:justify-center md:space-y-2 text-sm md:text-base font-geist-mono">
                {["About", "Work", "Experience", "CV"].map((item, index) => (
                    <span
                        key={index}
                        onClick={() => handleChange(item.toLowerCase())}
                        className={`cursor-pointer flex flex-col w-fit after:w-full after:bg-neutral-300 after:h-0.5 after:max-w-0 hover:text-neutral-300 hover:after:max-w-full after:duration-500 transition-all ${
                            selected === item.toLowerCase()
                                ? "text-neutral-300 after:max-w-full"
                                : ""
                        }`}
                    >
                        {item}
            ...
            <div className="hidden md:flex items-end md:h-2/5">
                <section className="flex space-x-2">
                    <a href="https://github.com/Alwexis" target="_blank">
                        <svg
                    ...
                    <a href="https://www.linkedin.com/in/arielsilvar" target="_blank">
                        <svg
                            className="cursor-pointer w-6 hover:scale-110 hover:text-neutral-300 transition-all"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                    ...
                    <a href="https://x.com/alwexis_dev" target="_blank">
                        <svg
                            className="cursor-pointer w-6 hover:scale-110 hover:text-neutral-300 transition-all"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                    ...
                    <a href="mailto:arielsilvar.dev@gmail.com">
                        <svg
                            className="cursor-pointer w-6 hover:scale-110 hover:text-neutral-300 transition-all"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
