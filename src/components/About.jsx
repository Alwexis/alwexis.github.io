export default function About() {
    return (
        ...
        >
            ...
            <h2 className="text-4xl font-space-grotesk text-neutral-100">
                About
            </h2>
            <p
                id="about"
                className="whitespace-pre-line text-neutral-200 md:text-2xl font-space-grotesk"
            >
                ...
                <b className="text-neutral-50">Fullstack development</b>,{" "}
                <b className="text-neutral-50">Mobile development</b>, and some
                in{" "}
                <b className="text-neutral-50">
                    Machine Learning/Deep Learning
                </b>{" "}
                and <b className="text-neutral-50">Data Science</b>.
            </p>
        </section>
    );
}
