...
export default function ExperienceCard({ experience }) {
    ...
    return (
        <div className="colored-corners-2 px-8 py-8 h-fit w-full flex flex-col">
            <a href={experience.company.url} target='_blank' className="flex items-center space-x-2 text-xl font-space-grotesk text-neutral-100">
            ...
            <div className='flex items-center justify-between text-neutral-200 text-xs font-geist-mono'>
                <span>{experience.startDate} - {experience.endDate} ({experience.difference})</span>
                <span>{experience.location}</span>
            </div>
            <p className="text-neutral-300 font-geist font-light overflow-hidden transition-all">
